...
titles = {
    ...
    'de': 'Einf\xfchrung in iDOC=',
    'fi': 'iDOC=:n esittely',
    'es': 'Introducci\xf3n a iDOC=',
    'hu': 'Bevezet\xe9s az iDOC-ba',
}
...
langlinks(lang, 'intro.%s.html', titles)
...
# Document body
page(lang, dateformats[lang], 'intro', 'intro.input')

# Link back
page(lang, dateformats[lang], 'intro', 'backtohome.input')
